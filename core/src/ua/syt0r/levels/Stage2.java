...
public class Stage2 extends GameScreen {
    ...
    public void show() {
        ...
        */
        ...
        enemy1.setShootingPattern(new SimpleShootingPattern(this));
        addEnemy(enemy1, 50);
        ...
        enemy2.setShootingPattern(new SimpleShootingPattern(this));
        addEnemy(enemy2, 200);
        ...
        enemy4.setShootingPattern(new SimpleShootingPattern(this));
        addEnemy(enemy4, 250);
    }
